...
description: >
  MilovanTomasevic Website v4 adds *a lot* of social media icons and introduces a new default layout. It also breaks things, hence a new major release number.
hide_description: true
excerpt_separator: <!--more-->
---

MilovanTomasevic Website v4 adds *a lot* of social media icons and introduces a new default layout.
