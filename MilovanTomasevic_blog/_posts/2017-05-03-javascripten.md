...
description: >
  MilovanTomasevic Website v6 adds a layer of JavaScript, effectively turning the whole site into a single page app.
hide_description: true
---

MilovanTomasevic Website has always featured a JavaScript-heavy sidebar, but other than that, JS has been used sparingly.
