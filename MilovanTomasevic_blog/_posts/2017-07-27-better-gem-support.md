...
description: >
  MilovanTomasevic Website v6.5 includes various quality-of-life improvements, especially when using the gem-based version of the theme.
...
## Patch Notes
### Added
* MilovanTomasevic Website now uses additional Jekyll plugins by default, which make working with GitHub more convenient.
